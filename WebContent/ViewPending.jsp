...
<div class="content">
    ...
    <table>
        <tr>
            ...
            <th>password</th>
            <th>Approve</th>
            <th>Disapprove</th> <!-- Added this line -->
        </tr>
        ...
        <tr>
            ...
            <td><a href="ApproveStation.jsp?id=<%= rs.getInt(1) %>">Approve</a></td>
            <td><a href="Disapprove.jsp?id=<%= rs.getInt(1) %>">Disapprove</a></td> <!-- Added this line -->
        </tr>
        <% } // End of while loop %>
        <% } catch (Exception e) {
            e.printStackTrace();
