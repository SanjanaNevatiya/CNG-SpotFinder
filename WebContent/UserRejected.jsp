...
<div class="sidebar">
    <h2>Fuel Station Management</h2>
     <ul>
        ...
        <li><a href="ViewApproved.jsp">Search Fuel Station</a></li>
        <li><a href="ViewDisapproved.jsp">View Assigned Bookings</a></li>
        <li><a href="ViewDeliveryBooking.jsp">View Delivered Bookings</a></li>
    ...
    <table>
        ...
        try {
            ...
            ps.setInt(2,GetterSetterUser.getId());
