...
<div class="sidebar">
    ...
    <div class="container">
        ...
        <div class="search-form">
             <form action="SearchFuelStation.jsp">
             <h5>Enter city</h5>
<input type="text" name="City" placeholder="Enter city of fuelStation" required>
             <h5>Enter pincode</h5>
<input type="text" name="pincode" placeholder="Enter Pincode of fuelStation" required>
...
try
{
	...
	PreparedStatement ps=con.prepareStatement("select * from fuelstation where City=? and status=?");
	 ps.setString(1,City);
	...
	{%>
          ...
          <td><a href="BookFuel.jsp?stationid=<%=rs.getInt(1) %>">Book</a></td>
           </tr>
        <%
